...
export default function Contact() {
  ...
  const handleEmailUs = () => {
    window.location.href = 'mailto:hello@codastra.com'
  }
              ...
              <div className="bg-gradient-to-r from-blue-900/30 to-purple-900/30 rounded-3xl p-8 border border-gray-700">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <button 
                    ...
                    className="flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg font-semibold hover:from-blue-700 hover:to-purple-700 transition-all duration-300"
                  >
                  ...
                  <button 
                    ...
                    className="flex items-center justify-center gap-2 px-6 py-3 border-2 border-gray-600 text-white rounded-lg font-semibold hover:border-blue-500 hover:text-blue-400 transition-all duration-300"
                  >
